        ...
        <nav className="bg-cyan-50">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-4 justify-between">
                            ...
                            <Link to="/allusers" className="hover:bg-cyan-500 hover:text-white text-titans px-3 py-2 rounded-md text-sm font-medium">All users</Link>
                        </div>
                    </div>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <Link to="/allusers" className="hover:bg-cyan-500 text-titans block px-3 py-2 rounded-md text-base font-medium">All users</Link>
                </div>
            </div>
        </nav>
    );
